 ...
 * Monitor prompt
 */
#define CONFIG_SYS_PROMPT		"dq-EVAL> "
...
#define CONFIG_SYS_FSMC_PSRAM_BCR	0x00001001
#define CONFIG_SYS_FSMC_PSRAM_BTR	0x00000800
#define CONFIG_SYS_FSMC_PSRAM_BWTR	0x0FFFFFFF
//#define CONFIG_FSMC_NOR_PSRAM_CS2_ENABLE

#define CONFIG_SYS_RAM_BASE		0x64000000 //xiugai wei CONFIG_MEM_RAM_BASE+100****************
...
#define CONFIG_ENV_ADDR			(0x08015000) //add to CONFIG_MEM_RAM_BASE 0x20000000
...
#define CONFIG_STM32_USART_PORT		1	/* USART3 to usart1**************/
#define CONFIG_STM32_USART_TX_IO_PORT	0	/* PORTC to A*/
#define CONFIG_STM32_USART_RX_IO_PORT	0	/* PORTC to A */
 ...
 * Needed by "loadb"
 */
#define CONFIG_SYS_LOAD_ADDR		0x08020040
...
#define CONFIG_HOSTNAME			dq_stm32-eval
#define CONFIG_BOOTARGS		        "stm32_platform=stm3240g-eval mem=2M console=ttyS0,115200 earlyprintk"
